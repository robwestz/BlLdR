...
#   - discoveries.jsonl, session-brief.md, distilled.md, handoff.md
...
CHECKPOINTS_DIR="$ULTIMA_ROOT/continuum/checkpoints"
...
for ctx_file in session-brief.md distilled.md handoff.md; do
  SRC="$ULTIMA_ROOT/context/$ctx_file"
  if [[ -f "$SRC" ]]; then
